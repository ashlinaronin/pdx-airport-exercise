...
const WeatherReportSummary = ({ daysAcUsed, daysHeatUsed, month, year }) => (
  <div className="weather-report-summary">
    <ReportKey />
    <p>
      During {month} {year}, the AC system at Portland International Airport was
      turned on at least once a day for {daysAcUsed} days. The heating system
      was turned on at least once a day for {daysHeatUsed} days.
    </p>
  </div>
);
